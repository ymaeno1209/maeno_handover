...
mpiexec --oversubscribe -n 2 --hostfile hosts1 ./requester_garea_read_copy : -n 1 --hostfile hosts2 ./coupler_garea_read_copy : -n 2 --hostfile hosts31 ./worker1_garea_read_copy;
