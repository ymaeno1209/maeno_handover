...
-np $sim_ppr ./diff_requester_new $num $step_num $sim_times_per_step : -np 1 ./diff_coupler $num $step_num : -np $vis_ppr ./diff_worker $num $step_num $vis_x_split $vis_z_split $vis_procs $node $sim_ppr $vis_ppr $sim_times_per_step\
