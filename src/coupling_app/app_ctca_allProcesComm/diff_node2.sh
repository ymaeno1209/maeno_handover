...
-np $sim_ppr ./diff_requester $num $step_num $sim_times_per_step : -np $vis_ppr ./diff_worker $num $step_num $vis_x_split $vis_z_split $vis_procs $node $sim_ppr $vis_ppr $sim_times_per_step\
